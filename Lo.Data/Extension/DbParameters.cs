...
namespace Lo.Data.Extension
{
    ...
    public class DbParameters
    {
        ...
        {
            return CreateDbParmCharacter(DbHelper.DbType);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string CreateDbParmCharacter(DatabaseType databaseType)
        {
        ...
        {
            return ToDbParameter(dbParameter, DbHelper.DbType);
        }
        /// <summary>
        /// 转换对应的数据库参数
        /// </summary>
        /// <param name="dbParameter">参数</param>
        /// <returns></returns>
        public static DbParameter[] ToDbParameter(DbParameter[] dbParameter, DatabaseType databaseType)
        {
            int i = 0;
